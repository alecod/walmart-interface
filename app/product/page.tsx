...
async function PorductPage({ searchParams: { url } }: Props) {
    ...
    return (
        <div className="p-4 lg:p-10 flex flex-col lg:flex-row w-full">
            ...
            <div className="flex-1 border rounded-md w-full p-5 space-y-5">
                ...
                <div dangerouslySetInnerHTML={{ __html: product.description }} className="py-5 text-sm" />
                ...
                <p className="text-2xl font-bold mt-2">{product?.currency} {product.price}</p>
