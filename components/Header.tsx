...
function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row items-center bg-wallmart px-10 py-7 space-x-5">
      ...
      <div className="flex space-x-5 mt-5 md:mt-0">
        ...
        <Link href={"/basket"} className="flex flex-col text-white font-bold items-center space-x-2 text-sm">
